...
import { TextInput, Title, Button, Textarea, Text, Image, SimpleGrid, Group, Card } from '@mantine/core';
...
function Date() {
    ...
    const form = useForm({
        ...
        validate: {
            date: (value) => (value.length < 2 ? 'Title must have at least 2 letters' : null),
    ...
    return (
        <>
            ...
            <Modal opened={opened} onClose={close} title="Ajouter une date">
