...
import { TextInput, Button, Textarea, Text, Image, SimpleGrid, Title, Group, Card } from '@mantine/core';
...
function Institut() {
    ...
    return (
        <>
            ...
            <Modal opened={opened} onClose={close} title="Ajouter un institut">
                <form onSubmit={form.onSubmit((values) => submitForm(values))}
                    className="flex flex-row space-x-4 items-start h-full w-full">
                    <div className="w-full">
                        <div className="flex flex-col justify-between pdx-28 pdb-10 shadow-xl rounded-md">
